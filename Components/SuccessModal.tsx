...
const Modal: React.FC<modalprops> = ({
	...
	return (
		<div
			className={`absolute bg-black-100/50 top-0 bottom-0 left-0 right-0 z-30 flex flex-col justify-center items-center ${extrastyling} `}
		>
			<div className="bg-white max-w-[19rem] w-[19rem] h-[12rem] rounded-[4px] flex flex-col justify-center items-center space-y-2">
				...
				<Link
					href={linkto}
					className="text-[#F6CC16] underline tracking-wide text-sm text-center montserrat"
				>
					{whereto}
				</Link>
			</div>
