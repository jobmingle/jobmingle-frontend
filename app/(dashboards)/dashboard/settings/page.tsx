...
const Page = () => {
	...
	return (
		<div className=" flex flex-col items-center gap-3 h-auto relative min-h-screen">
			{/* Edit profile */}
			...
			<section className=" w-full lg:max-w-[30rem] px-2 sm:px-20 md:px-0">
				<h2 className="font-bold text-xl montserrat text-center capitalize tracking-wide sora py-2">
					Create new password
				</h2>
