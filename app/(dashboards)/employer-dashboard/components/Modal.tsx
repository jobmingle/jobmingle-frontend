...
const Modal: React.FC<CompProps> = ({ ChosenJob, setActive }) => {
	...
	const [formData, setFormData] = useState({
		platform: ChosenJob.platform,
		link: ChosenJob.website,
		email: "",
		jobres: "",
		type: "",
		salary: "",
	...
	return (
		<div
			className={
				"absolute top-0 bottom-0 right-0 left-0 min-h-screen bg-[#f1f1f1] px-5 sm:px-0 flex flex-col items-center z-40 "
			}
			// style={{border: "1px solid red"}}
		>
			<div className="p-0 m-0 h-full w-full flex flex-col overflow-x-hidden ">
				<h3 className="montserrat capitalize text-3xl sm:text-3xl font-bold text-center mt-4 pb-6 sm:pb-3  ">
					Update Job
				</h3>
