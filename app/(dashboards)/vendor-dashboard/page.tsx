...
const Page = () => {
   ...
   return (
      <div className="min-h-[70vh] sm:min-h-[85vh] md:min-h-[90vh] h-auto mx-2 md:mx-0">
         {Jobs >= 1 ? (
            <main className=" w-full h-auto min-h-[35vh] md:min-h-[50vh] rounded-md my-10 p-2 lg:p-4 sora">
               <div className=" flex justify-between gap-4 items-center flex-wrap">
                  <section className="flex flex-col gap-5">
                     ...
                     <p className="text-sm lg:text-[100%] font-bold montserrat text-cebbter sora">Here is your course listing statistics from july-september 2023</p>
                  </section>
                  <section>
                     <input
                        type="date"
