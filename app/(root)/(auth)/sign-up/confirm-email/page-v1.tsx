...
// 												type="text"
// 												maxLength={1}
// 												className="w-[50px] h-[50px] text-2xl text-center border-[1px]  overflow-y-hidden border-solid rounded-[5px] border-black-100"
// 												onChange={(e) => {
// 													if (
// 														/^[0-9]$/.test(e.target.value) ||
// 														e.target.value === ""
// 													) {
// 														// Allow only digits or empty string (clearing the input)
// 														field.onChange(e);
// 														if (e.target.value !== "") {
...
// 														// Focus the previous input when Backspace is pressed on an empty field
...
// 														e.key !== "Delete"
// 													) {
// 														e.preventDefault(); // Block non-digit key presses, allow 'Backspace', 'Arrow' keys, and 'Delete'
// 													}
// 												}}
// 											/>
// 										)}
