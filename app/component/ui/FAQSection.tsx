...
const FAQSection = () => {
	...
	return (
		<div
			id="FAQ"
			className="flex justify-around items-center max-w-screen-xl mx-auto px-5 bg-white h-[100%] mb-16 mt-16 md:mt-20"
		>
			...
			<div className="w-full max-lg:mt-10">
				<div className="grid divide-y divide-neutral-200 max-w-xl mx-auto">
					<div className="flex flex-col ">
						<h2 className="font-bold text-5xl  tracking-tight mb-2 text-center md:text-left">
							FAQs
						</h2>
					</div>
