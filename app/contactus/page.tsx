...
export default function Contact() {
  return (
    ...
    >
      ...
      <h1 className="text-6xl mb-8 text-yellow-400 font-bold">
        Contact Information
      </h1>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-5">
          ...
          />
          <Button className="bg-yellow-400 text-white py-2 px-4 rounded h-[30px]  w-[300px] max-md:w-[100px] hover:bg-yellow-500">
            Subscribe Now
          </Button>
        </div>
      </div>
