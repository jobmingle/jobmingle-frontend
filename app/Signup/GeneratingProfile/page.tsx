...
const page = () => {
   ...
   return (
      <main className={`text-black min-h-[110vh] h-auto lg:min-h-[120vh] overflow-x-hidden ${ModalActive2 ? "overflow-y-hidden max-h-[100vh] h-[100vh]" : null}`}>
         {ModalActive ? (
         ...
         {ModalActive2 ? (
            <SuccessModal extrastyling={" min-h-[123vh] sm:min-h-[110vh] lg:min-h-[120vh] "} Act={"Account Created Successfully"} linkto={"/"} whereto={"Click Here To Continue"} />
         ) : null}
