   ...
   return (
      <div className="min-h-[100vh] border relative">
         ...
         <div className="p-0 m-0 h-full flex flex-col sm:flex-row sm:justify-center overflow-x-hidden">
            <div
               className=" relative hidden lg:flex w-full md:w-[50%] sm:h-[100vh] lg:h-[120vh] xl:h-[110vh] bg2 "
               //  style={{border: "1px sold blue"}}
            >
               <Image src={jobmingle} alt="logo" className="w-[4.5rem] h-12 ml-4 sm:ml-8 mt-8" />
            </div>
            <div
               className=" w-full lg:w-[50%] min-h-[100vh] bg-[#FEFEFE] sm:h-[110vh] lg:h-[120vh] xl:h-[110vh] flex sm:justify-center relative flex-col items-center pb-6 sm:pb-3  "
