	...
	return (
		<div className="flex max-md:flex-col justify-center md:gap-5 mb-5 lg:my-16">
			...
			<div className="grid  max-md:grid-cols-3 max-md:gap-0 md:grid-cols-5  p-2 items-center justify-center text-center w-full">
				...
				<div className="flex md:hidden justify-center items-center flex-col h-[10rem] w-full   border border-yellow-500 md:rounded-r-2xl hover:bg-yellow-400 transition ease-in-out delay-100 duration-1000">
					<div>
